...
//         {/* Navigation Arrows */}
//         <div className="position-absolute start-0 bottom-0 mb-5 ms-3">
//           <Button
//             onClick={onPrevClick}
...
//         <div className="position-absolute end-0 bottom-0 mb-5 me-3">
//           <Button
//             onClick={onNextClick}
//             className="rounded-circle border-0 d-flex align-items-center justify-content-center"
//             style={{
...
const Slider = () => {
  ...
  const handleExploreClick = () => navigate("/vehicles");
      ...
      <Container className="h-100 position-relative" style={{ zIndex: 2 }}>
        <Row className="h-100 align-items-center">
          ...
          <Col lg={6} className="order-2 order-lg-1">
            <div className="text-start">
              <span
                className="badge px-3 py-2 rounded-pill fw-medium mb-4 d-inline-block"
                style={{
          ...
          <Col lg={6} className="order-1 order-lg-2">
            ...
            >
              ...
              {/* --- arrows now live INSIDE this wrapper --- */}
              <Button
                onClick={onPrevClick}
                className="position-absolute top-50 start-0 translate-middle-y rounded-circle border-0 d-flex align-items-center justify-content-center"
                style={{
                  width: 50,
                  height: 50,
                  backgroundColor: isDark
              ...
              <Button
                onClick={onNextClick}
                className="position-absolute top-50 end-0 translate-middle-y rounded-circle border-0 d-flex align-items-center justify-content-center"
                style={{
                  width: 50,
                  height: 50,
                  backgroundColor: isDark
