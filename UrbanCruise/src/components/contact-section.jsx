...
const ContactSection = () => {
  ...
  const uiColors = {
    ...
    formCardShadow: isDark
      ? "0 8px 25px rgba(0,0,0,0.5)"
      : "0 8px 25px rgba(0,0,0,0.1)",

    formControlBg: isDark ? "#2A2A2A" : "#F8F8F8",
    formControlColor: isDark ? "#E0E0E0" : "#333333",
    // Placeholder color  now primarily handled by SCSS, but keeping this for consistency if SCSS is not applied
    formControlPlaceholderColor: isDark ? "#D0D0D0" : "#888888",
    formControlBorder: isDark ? "1px solid #4A4A4A" : "1px solid #D0D0D0",
    formControlFocusShadow: isDark
      ? "0 0 0 0.25rem rgba(32, 201, 151, 0.25)"
  ...
  const loadingContent = (
    <div className="text-center py-5">
      ...
      <p className="mt-3" style={{ color: uiColors.formControlColor }}>
        Sending message...
      </p>
    </div>
  );
  ...
  const handleContactSubmit = async (event) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        didOpen: (popup) => {
          // This part is still needed for runtime styling if customClass isn't fully supported
          if (isDark) {
                    ...
                    <div className="d-grid mt-3">
                      <Button
                        ...
                        style={{
                          ...
                          border: `2px solid ${
                            isButtonHovered
                              ? uiColors.buttonHoverBorder
                              : uiColors.buttonBorder
                          }`,
                          borderRadius: "10px",
                          transition: uiColors.transition,
                          boxShadow: isButtonHovered
                            ? uiColors.buttonHoverShadow
                            : uiColors.buttonShadow,
                          cursor: "pointer",
                        }}
